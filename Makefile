...
# NOTE: Since I built and wrote the game in Windows, I was too lazy to make it auto generate the .pkg on Linux.
# You can use the PkgTool that comes with OO toolchain to gen the package yourself.
# Just use the pkg/pkg.gp4 project file.

# Have fun!

# Libraries linked into the ELF.
LIBS        := -lc -lkernel -lc++ -lSceVideoOut -lScePad -lSceUserService -lSceSystemService -lSceFreeType -lSceSysmodule
